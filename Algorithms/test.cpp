...
//void askForVector(vector<int> vector); seems no effect
...
// according to the terminal input
    for (int i = 0; i < g.selected_pixel.size(); i++){
        ...
        cout << inputContent[char_y] << endl;
        cout << "change from " << inputContent[char_y][char_x] << "to " << *argv[4] << endl;  //***
